...
class FakeHospitalReports extends StatefulWidget {
  FirebaseFirestore _firestore = FirebaseFirestore.instance;
  @override
  _FakeHospitalReports createState() => _FakeHospitalReports();
}

class _FakeHospitalReports extends State<FakeHospitalReports> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream:
            widget._firestore.collection('fake hospital reports').snapshots(),
