...
class FakePoliceReports extends StatefulWidget {
  FirebaseFirestore _firestore = FirebaseFirestore.instance;
  @override
  _FakePoliceReports createState() => _FakePoliceReports();
}

class _FakePoliceReports extends State<FakePoliceReports> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: widget._firestore.collection('fake police reports').snapshots(),
