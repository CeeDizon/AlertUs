...
class CompletedFireReports extends StatefulWidget {
  FirebaseFirestore _firestore = FirebaseFirestore.instance;
  @override
  _CompletedFireReports createState() => _CompletedFireReports();
}

class _CompletedFireReports extends State<CompletedFireReports> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream:
            widget._firestore.collection('completed fire reports').snapshots(),
