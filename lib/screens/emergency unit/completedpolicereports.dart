...
class CompletedPoliceReports extends StatefulWidget {
  FirebaseFirestore _firestore = FirebaseFirestore.instance;
  @override
  _CompletedPoliceReports createState() => _CompletedPoliceReports();
}

class _CompletedPoliceReports extends State<CompletedPoliceReports> {
  @override
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: widget._firestore
            .collection('completed police reports')
            .snapshots(),
